...
//         ...user,
//         brokerAccountsCount: user.broker_accounts_count || 0,
//       }))
//     );
...
//                       </div>
//                       <div>
//                         <span className="text-sm font-medium text-muted-foreground">Broker Account Count</span>
//                         <p>{selectedUser.brokerAccountsCount}</p>
//                       </div>
//                       <div>
...
const AdminDashboard = () => {
  ...
  const exportUsers = () => {
    const csvContent = [
      ['Name', 'Email', 'Country', 'Mobile', 'Broker Accounts', 'Status', 'Created At', 'Last Login'],
      ...users.map(user => [
        user.name,
        user.email,
        user.country,
        user.mobile,
        user.broker_accounts_count,
        user.status,
        user.created_at,
        user.last_login || 'Never'
      ])
                              ...
                              <div className="flex items-center justify-between">
                                <div className="flex items-center gap-4">
                                  ...
                                  <div className="flex-1">
                                    <div className="flex items-center gap-3">
                                      <h4 className="font-semibold">{user.name}</h4>
                                      {user.broker_accounts_count > 0 && (
                                        <Badge variant="outline" className="text-xs">
                                          {user.broker_accounts_count} broker account{user.broker_accounts_count > 1 ? 's' : ''}
                                        </Badge>
                                      )}
                                    </div>
                                    <p className="text-sm text-muted-foreground">{user.email}</p>
                                ...
                                <div className="flex items-center gap-3">
                                  ...
                                  <div className="flex gap-2">
                                    ...
                                    {/* Delete button for rejected users */}
                ...
                {selectedUser ? (
                  <div className="space-y-6">
                    ...
                    <div className="space-y-3">
                      ...
                      <div>
                        <span className="text-sm font-medium text-muted-foreground">Broker Accounts</span>
                        <p>{selectedUser.broker_accounts_count || 0}</p>
                      </div>
                      <div>
                        <span className="text-sm font-medium text-muted-foreground">Mobile</span>
                        <p>{selectedUser.mobile}</p>
